...
if __name__ == "__main__":
    ...
    # Envs
    n_envs = 4
    fixed_init_train = False
    fixed_init_valid = True
    wind_model = 'simple'
    wind_force = [0.0,0,0] # drag_coeff_xy="9.1785e-7" drag_coeff_z="10.311e-7"
    ...
    env_kwargs['fixed_init'] = fixed_init_valid
